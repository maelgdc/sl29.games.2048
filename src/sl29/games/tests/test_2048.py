...
def test__get_cases_vides():
    ...
    assert  result == [(0,0),(0,3),(1,1),(1,3),(3,3)], f"Le résultat aurait du être {[(0,0),(0,3),(1,1),(1,3),(3,3)]} mais il vaut {result}"
    print("OK")
...
def test__supprimer_zeros():
    ...
    result = _supprimer_zeros(plateau[0])
    assert  result == [2,4], f"Le résultat aurait du être {[2,4]} mais il vaut {result}"
    print("OK")
